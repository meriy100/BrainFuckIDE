...
var GlobalWebIndex$cmd_extra$Cmd$Extra$withTrigger = function (msg) {
	return GlobalWebIndex$cmd_extra$Cmd$Extra$with(
		GlobalWebIndex$cmd_extra$Cmd$Extra$perform(msg));
};
var author$project$Worker$Hello = {$: 'Hello'};
var author$project$Worker$init = function (_n0) {
	return A2(
		GlobalWebIndex$cmd_extra$Cmd$Extra$withTrigger,
		author$project$Worker$Hello,
		{});
};
...
var author$project$Worker$consoleLog = _Platform_outgoingPort('consoleLog', elm$json$Json$Encode$string);
var author$project$Worker$update = F2(
	function (msg, model) {
		return A2(
			GlobalWebIndex$cmd_extra$Cmd$Extra$with,
			author$project$Worker$consoleLog('Hello World'),
			model);
	});
